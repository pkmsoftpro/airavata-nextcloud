...
public class SEAGridContext {
    ...
    public String getNextcloudServername() { return properties.getProperty(SEAGridConfig.NEXTCLOUD_SERVERNAME); }

    public String getDavBasepath() {
        return properties.getProperty(SEAGridConfig.NEXTCLOUD_WEBDAV_BASEPATH);
    }
    ...
    public String getClientID() {
        return properties.getProperty(SEAGridConfig.CLIENT_ID);
    }
    ...
    public String getGrantType() {
        return properties.getProperty(SEAGridConfig.TOKEN_GRANTYPE);
    }

    public String getValidationURL() {
        return properties.getProperty(SEAGridConfig.TOKEN_VALIDATION_URL);
    }

    public String getBaseDownloadPath() {
        return properties.getProperty(SEAGridConfig.BASE_DOWNLOAD_PATH);
    }
